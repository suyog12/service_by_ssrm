...
async def clean_inventory():
    ...
    try:
        ...
        # ── Subscription — reset after every test ────────────────────────────
        # Must be outside the schema loop since these are core tables
        ...
        # Also reset any DB-driven plan feature overrides added by tests
        try:
            await conn.execute(
                """
